...
## E1 — completed 2026-09-01 20:39 UTC
...
| Test samples | 2728 |
| Test patients | 31 |
| 3D Dice (mean Â± SD) | 0.8799 Â± 0.0302 |
| 3D IoU (mean Â± SD) | 0.7868 Â± 0.0470 |
| HD95 mm (mean Â± SD) | 6.6700 Â± 3.0128 |
| Dice (mean ± SD) | 0.7765 ± 0.3101 |
| Jaccard / IoU (mean ± SD) | 0.7129 ± 0.3141 |
| Dice range | 0.0000 – 1.0000 |
| IoU range | 0.0000 – 1.0000 |
| Best validation Dice / IoU | 0.6822 / 0.6031 |
| Peak VRAM | 1.985 GB |
| Train time | 59.1 min |
| Inference | 36.15 ms/slice |

Artifacts remain on the training server at /mnt/data/users/trungptit/Left_atrium_segmentation/results/vit_large/e1/seed_2026. The DINOv2 paper reports Dice and Jaccard/IoU as mean ± SD; results are not directly comparable unless data split and protocol match.

## E2 — completed 2026-09-01 22:13 UTC
...
| Test samples | 2728 |
| Test patients | 31 |
| 3D Dice (mean Â± SD) | 0.9033 Â± 0.0239 |
| 3D IoU (mean Â± SD) | 0.8244 Â± 0.0394 |
| HD95 mm (mean Â± SD) | 5.3313 Â± 2.7402 |
| Dice (mean ± SD) | 0.8268 ± 0.2759 |
| Jaccard / IoU (mean ± SD) | 0.7706 ± 0.2848 |
| Dice range | 0.0000 – 1.0000 |
| IoU range | 0.0000 – 1.0000 |
| Best validation Dice / IoU | 0.7972 / 0.7311 |
| Peak VRAM | 8.636 GB |
| Train time | 91.2 min |
| Inference | 49.33 ms/slice |

Artifacts remain on the training server at /mnt/data/users/trungptit/Left_atrium_segmentation/results/vit_large/e2/seed_2026. The DINOv2 paper reports Dice and Jaccard/IoU as mean ± SD; results are not directly comparable unless data split and protocol match.

## E0 — completed 2026-09-01 22:52 UTC
...
| Test samples | 2728 |
| Test patients | 31 |
| 3D Dice (mean Â± SD) | 0.8808 Â± 0.0336 |
| 3D IoU (mean Â± SD) | 0.7886 Â± 0.0523 |
| HD95 mm (mean Â± SD) | 5.4184 Â± 1.9946 |
| Dice (mean ± SD) | 0.8328 ± 0.2556 |
| Jaccard / IoU (mean ± SD) | 0.7721 ± 0.2736 |
| Dice range | 0.0000 – 1.0000 |
| IoU range | 0.0000 – 1.0000 |
| Best validation Dice / IoU | 0.7454 / 0.6631 |
| Peak VRAM | 1.985 GB |
| Train time | 36.8 min |
| Inference | 36.32 ms/slice |

Artifacts remain on the training server at /mnt/data/users/trungptit/Left_atrium_segmentation/results/vit_large/e0/seed_3407. The DINOv2 paper reports Dice and Jaccard/IoU as mean ± SD; results are not directly comparable unless data split and protocol match.

## E1 — completed 2026-09-01 23:53 UTC
...
| Test samples | 2728 |
| Test patients | 31 |
| 3D Dice (mean Â± SD) | 0.8763 Â± 0.0297 |
| 3D IoU (mean Â± SD) | 0.7811 Â± 0.0464 |
| HD95 mm (mean Â± SD) | 7.3026 Â± 3.4707 |
| Dice (mean ± SD) | 0.7740 ± 0.3105 |
| Jaccard / IoU (mean ± SD) | 0.7094 ± 0.3140 |
| Dice range | 0.0000 – 1.0000 |
| IoU range | 0.0000 – 1.0000 |
| Best validation Dice / IoU | 0.6772 / 0.5956 |
| Peak VRAM | 1.985 GB |
| Train time | 58.1 min |
| Inference | 36.38 ms/slice |

Artifacts remain on the training server at /mnt/data/users/trungptit/Left_atrium_segmentation/results/vit_large/e1/seed_3407. The DINOv2 paper reports Dice and Jaccard/IoU as mean ± SD; results are not directly comparable unless data split and protocol match.

## E2 — completed 2026-09-02 02:04 UTC
...
| Test samples | 2728 |
| Test patients | 31 |
| 3D Dice (mean Â± SD) | 0.8839 Â± 0.0323 |
| 3D IoU (mean Â± SD) | 0.7934 Â± 0.0513 |
| HD95 mm (mean Â± SD) | 5.5332 Â± 1.7425 |
| Dice (mean ± SD) | 0.8382 ± 0.2496 |
| Jaccard / IoU (mean ± SD) | 0.7770 ± 0.2639 |
| Dice range | 0.0000 – 1.0000 |
| IoU range | 0.0000 – 1.0000 |
| Best validation Dice / IoU | 0.8040 / 0.7350 |
| Peak VRAM | 8.636 GB |
| Train time | 128.7 min |
| Inference | 50.75 ms/slice |

Artifacts remain on the training server at /mnt/data/users/trungptit/Left_atrium_segmentation/results/vit_large/e2/seed_3407. The DINOv2 paper reports Dice and Jaccard/IoU as mean ± SD; results are not directly comparable unless data split and protocol match.
